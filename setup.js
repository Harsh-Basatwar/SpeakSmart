...
if (!fs.existsSync(quizzesFile)) {
  ...
  console.log('✅ Quizzes database initialized');
}
...
if (!fs.existsSync(flashcardsFile)) {
  ...
  fs.writeFileSync(flashcardsFile, JSON.stringify(defaultFlashcards, null, 2));
  console.log('✅ Flashcards database initialized');
}
